...
export const provinceMap = data => ({
    ...
    visualMap: { // 左下角的颜色区域
        ...
        pieces: [ // 自定义『分段式视觉映射组件（visualMapPiecewise）』的每一段的范围，以及每一段的文字，以及每一段的特别的样式
            {gt: 900, lte: 1000, label: '分布密集', color: '#6ad86e'}, // (900, 1000]
            {gt: 500, lte: 900, label: '分布较多', color: '#9adcfa'}, // (500, 900]
            {gt: 310, lte: 500, label: '分布一般', color: '#ffeb3b'}, // (310, 500]
            {gt: 200, lte: 300, label: '分布少量', color: '#ff9800'}, // (200, 300]
            {gt: 10, lte: 200, label: '分布极少量', color: 'orangered'}, // (10, 200]
