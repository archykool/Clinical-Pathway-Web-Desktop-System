...
import { Menu, Icon, Card, Steps, Form, Input,
    ...
    Checkbox, Upload, Badge, List, Radio, ConfigProvider,
    Collapse,DatePicker, Descriptions, InputNumber } from 'ant-design-vue';
...
Vue.use(Menu).use(Icon).use(Card).use(Steps)
    ...
    .use(Radio).use(ConfigProvider).use(Collapse).use(DatePicker)
    .use(Descriptions).use(InputNumber);